...
public class TokenUtils {
  ...
  public static String generateTokenString(String jsonResName, Map<String, Long> timeClaims) throws Exception {
    ...
    // signature
    PrivateKey pk = readPrivateKey("/META-INF/key.pem");
    return generateTokenString(pk, "classpath:/META-INF/public-key.pem", jsonResName, timeClaims);
  }
